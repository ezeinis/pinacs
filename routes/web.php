...
Route::group(['middleware' => 'admin'], function()
{
    ...
    //transfer students
    Route::get('/admin/transfer/students/{class_index}','Admin\AdminTransferController@index');
    Route::get('/admin/transfer','Admin\AdminTransferController@transferStudents');
});
